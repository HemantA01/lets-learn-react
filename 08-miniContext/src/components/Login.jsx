...
function Login() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()  //used to prevent the default behaviour of the event
        setUser({ username, password })   //This is how we send the data
    }
//To align the lines: Alt + Shift + F
    return (
        <>
